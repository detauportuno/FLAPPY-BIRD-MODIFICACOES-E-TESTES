...
FONTE_GAMEOVER = pygame.font.SysFont('arial', 40)
FONTE_REINICIAR = pygame.font.SysFont('arial', 30)
FONTE_RECORDE = pygame.font.SysFont('arial', 30)
...
def desenhar_tela(tela, passaros, canos, chao, pontos, recorde, game_over_flag, using_vanilla_pipe=False, using_azul_pipe = False, using_amarelo_pipe =False, using_roxo_pipe = False):
    ...
    # Os numeros 255, 255, 255 são responsaveis por deixar o texto escrito na cor branca, mudar esses valores muda a cor do texto
    ...
    if game_over_flag:
        mensagem_gameover = FONTE_GAMEOVER.render("Game Over!", 1, (255, 255, 25))
        mensagem_reiniciar = FONTE_REINICIAR.render("Aperte Enter para Recomeçar", 1, (25, 255, 255))

        # Centralizar as mensagens de "Game Over" e "Aperte Enter para Reiniciar"
        # Modificar esses valores de divisão e soma/subtração muda a posiçãC:/Users/20.00961-5/Downloads/FlappyBird-Python-main/FlappyBird-Python-main/imgs/bg.pngo da frase na tela
        ...
        pos_y_reiniciar = TELA_ALTURA // 2 + mensagem_gameover.get_height() + 100
